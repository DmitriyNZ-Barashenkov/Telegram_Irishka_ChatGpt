...
async def cmd_help(message: types.Message):
    await message.answer("Список доступных команд:\n/start - начать диалог с Иришкой.\n/help - получить список доступных команд.\n/информация - получить описание бота.\n/спасибо разработчику - поддержать разработку Иришки", reply_markup=start_keyboard)
...
async def cmd_info(messag: types.Message):
    await message.answer("Телеграм-бот ChatGPT - это бот, который работает на базе модели GPT из компании OpenAI, и может проводить диалоги с пользователями, используя нейросеть для генерации текста.\n"
                         ...
                         "Бот написан энтузиастом, если хотите отблагодарить ботописца Welcom! - /спасибо разработчику")
...
def register_handlers(dp: Dispatcher):
    ...
    dp.register_message_handler(cmd_donat, commands={"спасибо разработчику", "оплата подписки"})
